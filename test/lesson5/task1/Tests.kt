...
class Tests {
    ...
    @Test
    fun lab2BackPacing() {
        //Проверим варианты с разным кол-вом элементов, но одинаковым весом и ценой
        //Сначала расположим дешевые элементы и получим в ответе множество из них
        assertEquals(
            setOf("Пиво", "Сухарики", "Рыбка"),
            bagPacking(
                mapOf(
                    "Пиво" to (6 to 500), "Рыбка" to (4 to 400), "Сухарики" to (3 to 200), "Стаут" to (13 to 1100)
                ),
                13
            )
        )
        //Однако, если расположим сначала дорогой элемент, тогда получим его в множестве.
        //На мой взгляд это не совсем ожидаемый результат или требуется дополнить условие.
        assertEquals(
            setOf("Стаут"),
            bagPacking(
                mapOf(
                    "Стаут" to (13 to 1100), "Пиво" to (6 to 500), "Рыбка" to (4 to 400), "Сухарики" to (3 to 200)
                ),
                13
            )
        )
        //Протестируем пограничный вариант
        assertEquals(
            setOf("Тортик"),
            bagPacking(
                mapOf("Тортик" to (400 to 700)),
                400
            )
        )
        ...
        assertEquals(
            emptySet<String>(),
            bagPacking(
                mapOf("Пирожное" to (401 to 500)),
                400
            )
        )
        //При одинаковой стоимости, но разных весах, выбирается первое
        assertEquals(
            setOf("Пирожное1"),
            bagPacking(
                mapOf("Пирожное1" to (400 to 500), "Пирожное2" to (401 to 500)),
                401
            )
        )
    }
